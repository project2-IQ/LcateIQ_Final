...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2026 at 05:33 PM
...
(11, 1, 'Project: مقهى في أبها, Type: مقهى, Location: خميس مشيط', 'Suitability: مناسب متوسط, Score: 46.5%', '0.47', 'مقهى في أبها', 'خميس مشيط', 1, 'مناسب متوسط', '46.50', '2026-05-03 15:19:44'),
(12, 1, 'Project: مقهى في أبها, Type: مقهى, Location: خميس مشيط', 'Suitability: مناسب جداً, Score: 46.5%', '0.47', 'مقهى في أبها', 'خميس مشيط', 1, 'مناسب جداً', '46.50', '2026-05-03 15:23:25'),
(13, 1, 'Project: مقهى في أبها, Type: مقهى, Location: أبها - حي الشرفية', 'Suitability: مناسب جداً, Score: 64.09%', '0.64', 'مقهى في أبها', 'أبها - حي الشرفية', 0, 'مناسب جداً', '64.09', '2026-05-03 15:28:37');
...
--
ALTER TABLE `ai_chat_analysis`
  MODIFY `chatID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
